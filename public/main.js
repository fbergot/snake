...
/***/ "./src/class/Ennemy/Ennemies.js":
/*!**************************************!*\
  !*** ./src/class/Ennemy/Ennemies.js ***!
  \**************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {

eval("\n\nObject.defineProperty(exports, \"__esModule\", ({\n   value: true\n}));\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _Draw2 = __webpack_require__(/*! ../Draw */ \"./src/class/Draw.js\");\n\nvar _Draw3 = _interopRequireDefault(_Draw2);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return call && (typeof call === \"object\" || typeof call === \"function\") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function, not \" + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar Ennemies = function (_Draw) {\n   _inherits(Ennemies, _Draw);\n\n   function Ennemies(_ref, thisArgGame) {\n      var storm = _ref.storm,\n          zombie = _ref.zombie;\n\n      _classCallCheck(this, Ennemies);\n\n      var _this = _possibleConstructorReturn(this, (Ennemies.__proto__ || Object.getPrototypeOf(Ennemies)).call(this));\n\n      _this.thisArgGame = thisArgGame;\n      _this.ctx = thisArgGame.ctx;\n      _this.stormImg = storm;\n      _this.zombieImg = zombie;\n      _this.stormPositions = { x: thisArgGame.canvasBox * 5, y: thisArgGame.canvasBox * 5 };\n      _this.zombiePositions = { x: 50, y: 50 };\n      _this._displayEnnemy = false;\n      return _this;\n   }\n\n   _createClass(Ennemies, [{\n      key: \"collisionSnakeFood\",\n      value: function collisionSnakeFood() {\n         if (this.stormPositions.x === this.thisArgGame.newHead.x && this.stormPositions.y === this.thisArgGame.newHead.y) {\n            alert(\"ok\");\n         }\n      }\n   }, {\n      key: \"update\",\n      value: function update(img, positions, canvasBox) {\n         this.drawImg(this.ctx, positions.x, positions.y, canvasBox, canvasBox, img);\n      }\n   }, {\n      key: \"draw\",\n      value: function draw(canvasBox) {\n         this.collisionSnakeFood();\n         this.update(this.stormImg, this.stormPositions, canvasBox);\n      }\n   }, {\n      key: \"displayEnnemy\",\n      set: function set(value) {\n         this._displayEnnemy = value;\n      },\n      get: function get() {\n         return this._displayEnnemy;\n      }\n   }]);\n\n   return Ennemies;\n}(_Draw3.default);\n\nexports[\"default\"] = Ennemies;\n\n//# sourceURL=webpack://snake/./src/class/Ennemy/Ennemies.js?");
...
/***/ "./src/assets/picture/storm.png":
/*!**************************************!*\
  !*** ./src/assets/picture/storm.png ***!
  \**************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("module.exports = __webpack_require__.p + \"376234f07f89026bafdf.png\";\n\n//# sourceURL=webpack://snake/./src/assets/picture/storm.png?");

/***/ }),

/***/ "./src/assets/picture/zombie.png":
/*!***************************************!*\
  !*** ./src/assets/picture/zombie.png ***!
  \***************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("module.exports = __webpack_require__.p + \"afab33a62140bbc723a9.png\";\n\n//# sourceURL=webpack://snake/./src/assets/picture/zombie.png?");
